 ...
 */
final class Version20191016133404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ADHERENT ADD nom VARCHAR(255) NOT NULL, ADD prenom VARCHAR(255) NOT NULL, ADD telephone INT NOT NULL, ADD adresse_mail VARCHAR(255) NOT NULL, ADD date_naissance DATE NOT NULL, ADD droit_image TINYINT(1) NOT NULL, DROP nomAdherent, DROP datePaiement, CHANGE adresse adresse VARCHAR(255) NOT NULL, CHANGE idadherent id INT AUTO_INCREMENT NOT NULL');
