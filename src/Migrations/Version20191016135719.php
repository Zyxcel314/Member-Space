 ...
 */
final class Version20191016135719 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(255) NOT NULL, ADD prenom VARCHAR(255) NOT NULL, ADD adresse VARCHAR(255) NOT NULL, ADD numero_telephone INT NOT NULL, ADD date_naissance DATE NOT NULL, ADD droit_image TINYINT(1) NOT NULL, ADD est_verifie TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP nom, DROP prenom, DROP adresse, DROP numero_telephone, DROP date_naissance, DROP droit_image, DROP est_verifie');
    }
}
